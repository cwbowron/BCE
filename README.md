...
find in this archive. It is alternatively known as BACE (Bowron-Abernethy Chess Engine) or BCE (Boo's Chess Engine).  Rob Abernethy worked and I worked together to add the learning algorithm for an AI class in graduate school.
